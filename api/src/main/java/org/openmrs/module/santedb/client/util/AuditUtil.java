...
import org.openmrs.module.santedb.client.api.impl.SanteDbClientServiceImpl;
...
public class AuditUtil {
	 ...
	 */
	public AuditMessage createPatientResolve(List<Patient> results, String remoteHost, Message query) throws SanteDbClientException
	{
		try
		{
			Terser terser = new Terser(query);
		...
		catch(Exception e)
		{
			...
			throw new SanteDbClientException("Error creating audit", e);
		}
	}
	 ...
	 * @throws SanteDbClientException 
	 */
	public AuditMessage createPatientAdmit(Patient patient, String remoteHost, Message query, Boolean success) throws SanteDbClientException
	{
		try
		{
			Terser terser = new Terser(query);
