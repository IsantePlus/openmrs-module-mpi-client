...
public final class MessageUtil {
	...
	{
		// URL
		if(domain.matches("^([a-z0-9+.-]+):(?://(?:((?:[a-z0-9-._~!$&'()*+,;=:]|%[0-9A-F]{2})*)@)?((?:[a-z0-9-._~!$&'()*+,;=]|%[0-9A-F]{2})*)(?::(\\d*))?(/(?:[a-z0-9-._~!$&'()*+,;=:@/]|%[0-9A-F]{2})*)?|(/?(?:[a-z0-9-._~!$&'()*+,;=:@]|%[0-9A-F]{2})+(?:[a-z0-9-._~!$&'()*+,;=:@/]|%[0-9A-F]{2})*)?)(?:\\?((?:[a-z0-9-._~!$&'()*+,;=:/?@]|%[0-9A-F]{2})*))?(?:#((?:[a-z0-9-._~!$&'()*+,;=:/?@]|%[0-9A-F]{2})*))?$"))
		...
		fhirIdentifier.setType( new CodeableConcept(new Coding("http://terminology.hl7.org/CodeSystem/v2-0203", "PT", "Patient External Identifier")));
	}
	 ...
	 * @throws RegexSyntaxException 
	 */
	public org.hl7.fhir.r4.model.Patient CreateFhirPatient(Patient patient, boolean localIdOnly) throws HL7Exception, RegexSyntaxException {
		...
		if ("-".equals(this.m_configuration.getLocalPatientIdRoot())) {
			...
			idnumber.setType( new CodeableConcept(new Coding("http://terminology.hl7.org/CodeSystem/v2-0203", "PI", "Patient External Identifier")));
